...
export const Circle: React.FC<CircleProps> = ({
  ...
  return (
    <div data-cypress="circle" className={`${styles.content} ${extraClass}`}>
      <div
        data-cypress="circle-head" 
